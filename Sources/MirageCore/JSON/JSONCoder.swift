...
public struct JSONCoder: Sendable {
    ...
    public func encode<T: Encodable>(
        ...
        do {
            ...
            clarification = context.debugDescription
        ...
        throw JSONError(
            process: .encode,
            referenceCode: referenceCode ?? "WRSA",
            clarification: clarification ?? "JSON encode failed.",
            details: details,
    ...
    public func decode<T: Decodable>(
        ...
        guard let data else {
            ...
            throw JSONError(
                process: .decode,
                referenceCode: referenceCode ?? "C85J",
        ...
        throw JSONError(
            process: .decode,
            referenceCode: referenceCode ?? "D4GK",
            clarification: clarification ?? "JSON decode failed.",
            details: details,
            underlyingErrors: [underlyingError].compactMap(\.self),
            userInfo: errorUserInfo,
            data: data)
